...
ACCESS_TOKEN = "EAAR4EKodEE4BPPCGcE9MNZAz91pZChCcxZAKoZCXONIq2waBNVdIorZAyd60wEyEfw2XMmf7mFR5nmkFKC9Xcp1UtYSehIy7TbHo4IOD47yZBDPLSgHLbS4zjqNZCl13N7WRXVm39Kz8hKG08IMaafp3zlLXmQsQ41w8gD1ZBEni80eJujcei3Bqg7lveZCVVNFTEtWdE6Agh7L9DVfDyZBNx0gP6TJq7bb9Jsq3ZBZAD3LMy3GUdR8ZD"
        ...
        if messages:
            ...
            if msg_type == "text":
                ...
                handle_button_click(sender, button_id)
                    ...
                    send_message(sender, f"📎 Thanks! We received your {doc_type.replace('_', ' ')}. We'll process it shortly.")
